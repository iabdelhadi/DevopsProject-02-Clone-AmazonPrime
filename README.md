...
1. **Clone the Repository** (Open Command Prompt & run below):
   ```bash
   git clone https://github.com/iabdelhadi/DevopsProject-02-Clone-AmazonPrime.git
   cd DevopsProject2
...
pipeline {
    ...
    stages {
        stage('1. Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/iabdelhadi/DevopsProject-02-Clone-AmazonPrime.git'
            }
        }
        ...
        stage('Cleanup K8s Resources') {
            steps {
                script {
                    ...
                    sh 'kubectl delete deploy aitalicloud-app || true'
                    sh 'kubectl delete svc aitalicloud-app || true'
